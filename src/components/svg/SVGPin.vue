<template>
  <svg xmlns="http://www.w3.org/2000/svg" v-if="pinned" viewBox="0 0 24 24" @click.stop="onClick">
    <path
  ...
  <svg xmlns="http://www.w3.org/2000/svg" v-else viewBox="0 0 24 24" @click.stop="onClick">
    <path
